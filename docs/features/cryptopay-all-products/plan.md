...
- **Status:** approved
- **Scope revision:** 3 (immutable implementation clarification; revisions 1–2
...
- Scope Contract revision 3 без изменений принимает обязательное поведение из
  ...
  технический line budget CPAY-B1 с 700 до 1100 строк при неизменных файлах,
  компонентах и критериях завершения.
...
**Task packet CPAY-B1:** `scope_revision: 3`; ID `CPAY-001`; allowed files are
...
**Task packet CPAY-B2:** `scope_revision: 3`; ID `CPAY-002`; allowed files are
...
**Task packet CPAY-B3:** `scope_revision: 3`; ID `CPAY-003`; allowed files are
...
**Task packet CPAY-B4:** `scope_revision: 3`; ID `CPAY-004`; allowed files are
...
**Task packet CPAY-B5:** `scope_revision: 3`; ID `CPAY-005`; allowed files are
...
**Task packet CPAY-B6:** `scope_revision: 3`; ID `CPAY-006`; allowed files are
...
**Task packet CPAY-B7:** `scope_revision: 3`; ID `CPAY-007`; allowed files are
...
**Task packet CPAY-B8:** `scope_revision: 3`; ID `CPAY-008`; allowed files are
...
**Task packet CPAY-B9:** `scope_revision: 3`; ID `CPAY-009`; allowed files are
