...
### Task PMM-001: Корневой выбор продукта и вход в MTProxy
...
### Task PMM-002: Контекстный возврат из внутренних экранов MTProxy
...
### Task PMM-003: Вложенное VPN-меню и контекстный возврат
