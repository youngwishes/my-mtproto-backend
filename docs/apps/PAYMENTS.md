...
нейтральны. Нажатие уже показанной старой кнопки не проверяет активность или
приоритет повторно, а цены, invoice, callbacks, successful-payment routing и
fulfilment действующих Stars/Crypto Pay сценариев не меняются. Миграция
