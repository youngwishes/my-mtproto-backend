...
• Общее количество приглашённых: <b>{total_referrals_count}</b>
• Активировали пробный период: <b>{active_referrals_count}</b>
• Баланс яблок: <b>{apple_balance} 🍏</b>

За каждого друга, активировавшего пробный период, ты получаешь <b>15 🍏</b>.
