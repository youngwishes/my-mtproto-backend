...
VPN_NOT_PURCHASED_TEXT = """🛡 <b>VLESS VPN</b>

VPN-подписка ещё не оформлена.
"""

VPN_PREPARING_TEXT = """⏳ <b>VLESS VPN</b>

Доступ готовится. Ссылка придёт отдельным сообщением, когда VPN будет готов.
"""

VPN_READY_TEXT = """✅ <b>VPN-доступ готов</b>

Подписка действует до: <b>{expired_at}</b>

Используй стабильную ссылку ниже для подключения.
"""

VPN_EXPIRED_TEXT = """⌛ <b>Срок VPN-доступа истёк</b>

Подписка действовала до: <b>{expired_at}</b>
"""

VPN_DISABLED_TEXT = """⛔ <b>VPN-доступ отключён</b>

Если это произошло после возврата платежа по ошибке, напиши в поддержку: @mtproto_keys
"""

VPN_PAYMENT_ACCEPTED_TEXT = "Оплата принята, доступ готовится"
