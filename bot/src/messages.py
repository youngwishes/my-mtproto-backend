...
Сертификат даёт <b>30 дней доступа</b> к BeatVault. После оплаты ты получишь код формата <code>KEY-XXXX-XXXX</code> и сможешь переслать его другу или родственнику.
