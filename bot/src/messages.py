...
👥 Приглашено: <b>{total_referrals_count}</b>
✅ Получили пробный доступ: <b>{active_referrals_count}</b>
🍏 На балансе: <b>{apple_balance}</b>

Друг получает <b>14 дней бесплатно</b>, а ты — <b>15 🍏</b> после активации его пробного периода.
